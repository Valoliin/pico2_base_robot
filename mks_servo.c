...
/**
 * 1. FONCTION CALCUL : Remplit les 6 premiers octets de la trame de vitesse
 */
...
/**
 * 2. FONCTION CHECKSUM : Calcule et retourne le CRC d'un buffer
 */
...
/**
 * 3. FONCTION ENVOI : Gère uniquement le physique (RS485 + UART)
 */
...
/**
 * 4. FONCTION RÉCEPTION : Attend le ACK du moteur
 */
bool mks_read_ack()
{
    uint8_t rx_buf[5];
